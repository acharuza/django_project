"""
Django settings for wap_project project.
...
SECRET_KEY = 'django-insecure-w$jh^4)*wwhcly6x90_4%15r92*p4eyxmf-q8d^!^p--=ezhk7'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['192.168.101.181', '127.0.0.1']
...
WSGI_APPLICATION = 'wap_project.wsgi.application'
...
# email configuration - app is configured to work with gmail smtp
